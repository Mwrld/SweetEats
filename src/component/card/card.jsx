...
function Card(items){
  const {addToCart, removeFromCart, cartItems, updateCartItemCount, addToWishList, removeFromWishList, wishListItems, updateWishListCount, mode, setMode} = useContext(ShopContext)
